...
structure = get_structure_from_file('../structure-files/Mg2SiO4_mp-2895.cif')
# structure = get_structure_from_file('../structure-files/LaB6_Pm-3m_1986_icsd-612685.cif')

# Create a perturbed structure
pmg_struct = Structure.from_file(filename='../structure-files/Mg2SiO4_mp-2895.cif')
pmg_struct.perturb(0.5)
...
pseudo_family = load_group('PseudoDojo/0.5/PBE/SR/standard/upf')
builder.pseudos = pseudo_family.get_pseudos(structure=structure)
use_recommended_cutoffs = False
...
# Request the recommended wavefunction and charge density cutoffs
# for the given structure and energy units.
# Recommended cutoff only works for the SSP family
if use_recommended_cutoffs:
...
kpoints.set_kpoints_mesh_from_density(0.5)
