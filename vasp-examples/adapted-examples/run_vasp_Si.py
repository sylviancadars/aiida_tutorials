...
if __name__ == '__main__':
    ...
    CODE_STRING = 'vasp-5.4.4@jean-zay'
    ...
    OPTIONS.account = 'def@cpu'
    # Quality-of-service : On Jean-Zay, use :
    #   - 'qos_cpu-dev' for jobs requiring less than 2 hours
    #   - 'qos_cpu-t4' for jobs requiring more than 24 hours
    #   - '' for standard jobs between 2 and 24 hours
    OPTIONS.qos = 'qos_cpu-dev'
    OPTIONS.resources = {'num_machines': 1, 'num_mpiprocs_per_machine': 40}
    OPTIONS.queue_name = ''
    OPTIONS.max_wallclock_seconds = 20 * 60
